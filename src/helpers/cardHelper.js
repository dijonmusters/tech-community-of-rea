...
export const getTheme = theme => {
  ...
  switch(theme.toLowerCase()) {
    case 'residential': return { main: REA_RED, hue: '0' }
    case 'real commercial': return { main: RCA_BLUE, hue: '210' }
...
const getDreamJobStats = dreamJob => {
  ...
  switch (dreamJob.toLowerCase()) {
    case '$ lead': return { points: '3', type: 'pos', text: 'Lead' }
    case '$$ em': return { points: '5', type: 'pos', text: 'Eng. Manager' }
...
const getIDEStats = ide => {
  ...
  switch (ide.toLowerCase()) {
    case 'vs code': return { icon: 'vscode.png', points: '2', type: 'pos', text: 'Visual Studio Code' }
    ...
    case 'cli': return { icon: 'vim.png', points: '4', type: 'pos', text: 'Vim/Emacs/CLI' }
...
const getIndentStats = indent => {
  ...
  switch (indent.toLowerCase()) {
    case 'tab': return { points: '4', type: 'neg', icon: '|____|' }
    ...
    case '4 spaces (tab)': return { points: '0', type: 'neut', icon: '|_|_|_|_|' }
  }
}